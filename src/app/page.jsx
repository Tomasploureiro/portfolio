...
import { FaBriefcase, FaBolt, FaGithub, FaFacebook, FaInstagram, FaLinkedin, FaCode, FaMobileAlt, FaPaintBrush, FaEnvelope, FaArrowRight} from "react-icons/fa";
...
const Home = () => {
    ...
    const cardInView1 = useInView(cardRef1, { once: true, margin: "-100px" });
    const cardInView2 = useInView(cardRef2, { once: true, margin: "-100px" });
    const cardInView3 = useInView(cardRef3, { once: true, margin: "-100px" });
    const cardInView4 = useInView(cardRef4, { once: true, margin: "-100px" });
    ...
    return (
      <div>
              ...
              <main className="w-full">
                ...
                <div className="flex flex-col items-center gap-2 ">
                    <div className="flex items-center gap-4">
                        <h1 className="text-5xl font-semibold text-center md:text-6xl lg:text-8xl text-[var(--purple)]">ESTUDANTE</h1>

                        <h1 className="sm:text-xs md:text-sm lg:text-base"> 
                          // Baseado em <br /> Coimbra, Portugal 
                        </h1>
                    </div>
                    <div className="flex items-center gap-4">
                      <h1 className="sm:text-xs md:text-sm lg:text-base"> 
                      ...
                      <h1 className="text-5xl font-semibold text-center md:text-6xl lg:text-8xl text-[var(--yellow)]">ENGENHARIA</h1>
                    </div>
                    <div className="flex items-center gap-4">
                        <h1 className="text-5xl font-semibold text-center md:text-6xl lg:text-8xl">INFORMÁTICA</h1>
                        <Link
                          href="/contact"
                          className="flex items-center gap-2 p-4 rounded-full border border-[var(--border)] text-lg font-semibold text-[var(--foreground)] shadow-lg transition hover:scale-105 hover:border-green-400"
                ...
                <div className="flex items-center gap-4">    
                  <h1 className="text-5xl font-semibold text-center md:text-6xl lg:text-8xl text-[var(--foreground)]">&</h1>
                  <h1 className="text-5xl font-semibold text-center md:text-6xl lg:text-8xl text-[var(--cyan)]"> DESENVOLVEDOR.</h1>
                </div>
                </div>
                <div>
                  <h1 className="text-center sm:pt-4 md:text-2xl lg:text-3xl">
        ...
        <section className="ml-15 text-left mt-10 mr-15">
          <div>
            <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl mt-10">
                "Programar é entender o mundo em pequenos <br /> 
                blocos de lógica. Inovar é reorganizá-los <br />  de forma que ninguém pensou antes."
            </p>
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl mt-10 text-[var(--cyan)]"> Linus Torvalds </h1>
          </div>
          ...
          <div className="text-left mt-10">
            <p className="text-m sm:text-l md:text-xl lg:text-2xl">
          ...
          <div className="flex justify-end sm:mr-10 md:mr-14">
            <Link
              href="/about"
              className="flex justify-end items-center gap-2 p-4 rounded-full border border-[var(--border)] text-lg font-semibold text-[var(--foreground)] shadow-lg transition hover:scale-105 hover:border-foreground w-fit mt-8"
              style={{ boxShadow: "0 0 0 2px #222 inset" }}
            >
              <span className="flex rounded-full animate-pulse"></span>
              <h1>Sobre mim</h1>
              <FaArrowRight />
            </Link>
          </div>
        ...
        <section className="flex justify-center flex-col items-center mt-20">
          ...
          >
            ...
            >
              <Cards
                icon={<FaMobileAlt className="text-4xl text-purple-400 mb-6" />}
                title="Apps Mobile"
                desc="Desenvolvimento de aplicações móveis intuitivas e eficientes para Android e iOS."
        ...
        <section className="ml-15 mr-15 mt-18">
          ...
          <motion.div className="flex flex-col divide-y divide-[var(--border)]">
            <motion.div
              ...
              className="flex flex-col md:flex-row justify-between py-14"
            >
              <div className="ml-20 mr-20">
                <h3 className="text-3xl font-bold text-[var(--foreground)] mb-2">MercadoTV</h3>
                <div className="text-base text-[var(--foreground)] mb-2">2025</div>
              </div>
              <div className="flex flex-col items-end min-w-[220px] mt-6 md:mt-0 mr-20">
                <div className="text-xl font-semibold ">Full Stack Development</div>
                <div className="text-base text-[var(--foreground)]">React, Node.js, PostGreSQL</div>
              </div>
            </motion.div>
            <motion.div
              ref={ref2}
            ...
            >
              <div className="ml-20 mr-20">
                <h3 className="text-3xl font-bold text-[var(--foreground)] mb-2">NUCLEO DE ESTUDANTES DE INFORMATICA (NEI)</h3>
                <div className="text-base text-[var(--foreground)] mb-2">2023, 2024, 2025</div>
              </div>
              <div className="flex flex-col items-end min-w-[220px] mt-6 md:mt-0 ml-20 mr-20">
                <div className="text-xl font-semibold">Coordenador e colaborador</div>
              </div>
            </motion.div>
            <motion.div
              ref={ref3}
            ...
            >
              <div className="ml-20 mr-20">
                <h3 className="text-3xl font-bold text-[var(--foreground)] mb-2">VICAIMA</h3>
                <div className="text-base text-[var(--foreground)] mb-2">2021, 2023, 2024</div>
              </div>
              <div className="flex flex-col items-end min-w-[220px] mt-6 md:mt-0 ml-20 mr-20">
                <div className="text-xl font-semibold">Trabalho de verão</div>
              </div>
            </motion.div>
            <motion.div
              ref={ref4}
            ...
            >
              <div className="ml-20 mr-20">
                <h3 className="text-3xl font-bold text-[var(--foreground)] mb-2">RIO CAIMA</h3>
                <div className="text-base text-[var(--foreground)] mb-2">2025</div>
              </div>
              <div className="flex flex-col items-end min-w-[220px] mt-6 md:mt-0 ml-20 mr-20">
                <div className="text-xl font-semibold">Trabalho de verão</div>
          ...
          <Link
            href="/projects"
            className="flex items-center gap-2 p-4 rounded-full border border-[var(--border)] text-lg font-semibold text-[var(--foreground)] shadow-lg transition hover:scale-105 hover:border-foreground mt-12 mx-auto w-fit"
